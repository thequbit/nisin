	...
	if($count==1){
		...
		*/
		...
		if($validated==1)
		{
			...
			// redirect to pluginnewurl.php, we are now logged in.
			header("location:plugin_newurl.php");
			
		}
		else
		{
			echo "<meta http-equiv=\"REFRESH\" content=\"0;url=plugin_notvalidated.html\">";
		}
		
	}
	else {
		echo "<meta http-equiv=\"REFRESH\" content=\"0;url=plugin_badlogin.html\">";
	}
